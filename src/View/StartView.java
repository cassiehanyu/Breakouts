...
//        this.setFocusable(true);
        ...
        label_StartGame.setPreferredSize(new Dimension(width*4/5,height/10));
        label_StartGame.setForeground(Color.yellow);

        label_HowToStart = new JLabel("How To Play?");
        label_HowToStart.setPreferredSize(new Dimension(width*4/5,height/10));
        label_HowToStart.setForeground(Color.yellow);

        start_img1 = new JLabel();
        start_img1.setIcon(new ImageIcon(new ImageIcon("pic/start.png").getImage().getScaledInstance(height*1/10,height*1/10, Image.SCALE_AREA_AVERAGING)));
...
//
        ...
        c.gridx = 0;
        c.gridy = 0;
        c.insets = new Insets(0,width/20,height/20,0);
        add(start_img1, c);
        ...
        c.gridx = 1;
        c.gridy = 1;
//        c.insets = new Insets(0,width/20,0,0);
